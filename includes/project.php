...
<?php if (trim((string)$P['content']) !== ''): ?><div class="proj-content"><?php echo $P['content']; ?></div>
<?php elseif (trim((string)$P['descr']) !== ''): ?><div class="proj-content"><p><?php echo esc_html($P['descr']); ?></p></div><?php endif; ?>
